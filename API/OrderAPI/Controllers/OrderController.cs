...
namespace OrderAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        [HttpPatch]
        [Route("{id}")]
        public async Task<IActionResult> UpdateProductName(int id, OrderProductNameDTO orderProductNameDTO)
        {
            var rs = await _orderService.UpdateProductName(id, orderProductNameDTO.ProductName);
            return Ok(rs);
        }
    }
}
